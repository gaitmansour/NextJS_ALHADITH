...
export const getArticleById = (title) =>
    `${api_url}/article?fields[node--article]=title,body,created,field_image&filter[alqsm][condition][path]=title&filter[alqsm][condition][value]=${encodeURI(title)}&include=field_tags.vid,field_image`
...
export const getVideo1 = () =>
    `${api_url}/video?include=field_thumbnail_video,field_upload_video&fields[node--video]=title,field_description_video,field_lien_video,field_thumbnail_video,field_categorie_video,field_upload_video&&filter[field_categorie_video][condition][path]=field_categorie_video.name&filter[field_categorie_video][condition][value]=${encodeURI('برامج على الشبكات الاجتماعية')}`
export const getVideoBt = () =>
    `${api_url}/video?include=field_thumbnail_video,field_upload_video&fields[node--video]=title,field_description_video,field_lien_video,field_thumbnail_video,field_categorie_video,field_upload_video&&filter[field_categorie_video][condition][path]=field_categorie_video.name&filter[field_categorie_video][condition][value]=${encodeURI('برامج تلفزية')}`
export const getVideoBi = () =>
    `${api_url}/video?include=field_thumbnail_video,field_upload_video&fields[node--video]=title,field_description_video,field_lien_video,field_thumbnail_video,field_categorie_video,field_upload_video&&filter[field_categorie_video][condition][path]=field_categorie_video.name&filter[field_categorie_video][condition][value]=${encodeURI('برامج اذاعية')}`
export const getVideoDh = () =>
    `${api_url}/video?include=field_thumbnail_video,field_upload_video&fields[node--video]=title,field_description_video,field_lien_video,field_thumbnail_video,field_categorie_video,field_upload_video&&filter[field_categorie_video][condition][path]=field_categorie_video.name&filter[field_categorie_video][condition][value]=${encodeURI('الدروس الحديثية')}`
export const getVideoKi = () =>
    `${api_url}/video?include=field_thumbnail_video,field_upload_video&fields[node--video]=title,field_description_video,field_lien_video,field_thumbnail_video,field_categorie_video,field_upload_video&&filter[field_categorie_video][condition][path]=field_categorie_video.name&filter[field_categorie_video][condition][value]=${encodeURI('الدروس الحسنية')}`
