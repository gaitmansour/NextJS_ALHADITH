...
export const getArticlesByTag = (value) => `${base_url}/meta-tags?field_tags_target_id=${value}`
...
export const getArticleById = title =>
    `${api_url}/article?fields[node--article]=title,body,created,field_image&filter[alqsm][condition][path]=field_alqsm.name&filter[alqsm][condition][value]=${title}&include=field_tags.vid,field_image`;
