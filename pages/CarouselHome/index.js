            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <a
                      className={`${styles.btn} btn bg-success rounded-0 text-white d-flex align-items-center p-0 ${styles.carouselItem} itemCarousel`}
                    >
                      <i
                        className={`fas ${
                          isRTL ? 'fa-caret-right' : 'fa-caret-left'
                        } align-items-center d-flex align-self-stretch`}
                      />
