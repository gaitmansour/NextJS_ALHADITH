  ...
  const handleSearch = async (word, topic, degree) => {
    const data = {
      ...
      idTopic: door
        ? door.value
        : ChoiceTopic
        ? JSON.stringify(ChoiceTopic.value)
        : '',
      idCategorie: topic
  ...
  useEffect(() => {
    if (StartPage === 0) {
      getDataDegree().then((r) =>
        getDataCategory().then((res) => handleTopicFrom(res, r, router))
      )
      getDataSource()
      getDataNarrator()
      getDataTopic()
              ...
              <div className='d-flex flex-wrap flex-column'>
                <div className={`d-flex alignIte ${styles.alignIte}`}>
                  ...
                  <CustomSelect
                    ...
                    defaultInputValue={
                      door ? door : ChoiceTopic ? ChoiceTopic : ''
                    }
                    label='باب'
                ...
                <div className={`d-flex alignIte ${styles.alignIte}`}>
                  <CustomSelect
                    ...
                    defaultInputValue={
                      source ? source : ChoiceSource ? ChoiceSource : ''
                    }
                    label='المصدر'
                  ...
                  <CustomSelect
                    ...
                    label='درجة الصحة'
                    defaultInputValue={
                      degree ? degree : ChoiceDegree ? ChoiceDegree : ''
                    }
                  ...
                  <CustomSelect
                    ...
                    label='الراوي'
                    defaultInputValue={
                      narrator ? narrator : ChoiceNarrator ? ChoiceNarrator : ''
                    }
