...
import {getDataAPI, getDataAPIBi, getDataAPIBt, getDataAPIDh, getDataAPIKi, getDataLive} from "../../lib/allMedia";
...
const AllMedia = (props) => {
    ...
    console.log('props.',props.dataAPI)
   /* const [dataAPI, setDataAPI] = useState({})
    ...
    if (
        _.isEmpty(props.dataAPI) ||
        _.isEmpty(props.dataAPIDh) ||
        _.isEmpty(props.dataAPIBt) ||
        _.isEmpty(props.dataAPIBi) ||
        _.isEmpty(props.dataAPIKi)
    ) {
        return (
    ...
    var leng = props.dataAPI?.included.length
    var leng1 = props.dataAPIDh?.included.length
    var leng2 = props.dataAPIBt?.included.length
    var leng3 = props.dataAPIBi?.included.length
    var leng4 = props.dataAPIKi?.included.length
            ...
            <Body className={`TemplateArticleBody ${styles.Media} d-flex p-4`}>
                <div className='flex-fill ' style={{width: '100%'}}>
                                ...
                                >
                                    <ReactPlayer
                                        url={[
                                            {
                                                src: `${base_url}${
                                                    props.dataAPI.included[leng / 2]?.attributes?.uri?.url
                                                }`,
                                                type: 'video/mp4',
                                            },
                                        ]}
                                        light={`${base_url}/${props.dataAPI?.included[0]?.attributes?.uri?.url}`}
                                        controls
                                        playing
                                                    ...
                                                    >
                                                        <ReactPlayer
                                                            url={[
                                                                {
                                                                    src: `${base_url}${
                                                                        props.dataAPI?.included[i + leng / 2]?.attributes
                                                                            ?.uri?.url
                                                                    }`,
                                                                    type: 'video/mp4',
                                                                },
                                                            ]}
                                                            light={`${base_url}${props.dataAPI?.included[i]?.attributes?.uri?.url}`}
                                                            controls
                                                            playing
                  ...
                  > */}
                                ...
                                >
                                    <ReactPlayer
                                        url={[
                                            {
                                                src: `${base_url}${
                                                    props.dataAPIBt.included[leng2 / 2]?.attributes?.uri?.url
                                                }`,
                                                type: 'video/mp4',
                                            },
                                        ]}
                                        light={`${base_url}/${props.dataAPIBt?.included[0]?.attributes?.uri?.url}`}
                                        controls
                                        playing
                                        className={`${styles.reactPlayer} react-player`}
                                        width='95%'
                                ...
                                <h3 className={`${styles.titleVideo}`} style={{fontSize: 18}}>
                                    {props.dataAPIBt.data[0].attributes.title}
                                </h3>
                                <hr className={`${styles.line}`}/>
                                <div className={styles.SliderVideoList1}>
                                    <Slider {...settings} className='slide my-4'>
                                        {props.dataAPIBt?.data.map((item, i) => {
                                            return (
                                                // <div
                                                //   key={i.toString()}
                                                    ...
                                                    >
                                                        <ReactPlayer
                                                            url={[
                                                                {
                                                                    src: `${base_url}${
                                                                        props.dataAPIBt?.included[i + leng2 / 2]
                                                                            ?.attributes?.uri?.url
                                                                    }`,
                                                                    type: 'video/mp4',
                                                                },
                                                            ]}
                                                            light={`${base_url}${props.dataAPIBt?.included[i]?.attributes?.uri?.url}`}
                                                            controls
                                                            playing
                                                            className={`${styles.reactPlay} react-player`}
                                                            width='90%'
                  ...
                  > */}
                                ...
                                >
                                    <ReactPlayer
                                        url={[
                                            {
                                                src: `${base_url}${
                                                    props.dataAPIBi.included[leng3 / 2]?.attributes?.uri?.url
                                                }`,
                                                type: 'video/mp4',
                                            },
                                        ]}
                                        light={`${base_url}/${props.dataAPIBi?.included[0]?.attributes?.uri?.url}`}
                                        controls
                                        playing
                                        className={`${styles.reactPlayer} react-player`}
                                        width='95%'
                                ...
                                <h3 className={`${styles.titleVideo}`} style={{fontSize: 18}}>
                                    {props.dataAPIBi.data[0].attributes.title}
                                </h3>
                                <hr className={styles.line}/>
                                <div className={styles.SliderVideoList1}>
                                    <Slider {...settings} className='slide my-4' >
                                        {props.dataAPIBi?.data.map((item, i) => {
                                            return (
                                                // <div
                                                //   key={i.toString()}
                                                //   className='SliderVideoList-data1 d-flex flex-wrap'
                                                    ...
                                                    >
                                                        <ReactPlayer
                                                            url={[
                                                                {
                                                                    src: `${base_url}${
                                                                        props.dataAPIBi?.included[i + leng3 / 2]
                                                                            ?.attributes?.uri?.url
                                                                    }`,
                                                                    type: 'video/mp4',
                                                                },
                                                            ]}
                                                            light={`${base_url}${props.dataAPIBi?.included[i]?.attributes?.uri?.url}`}
                                                            controls
                                                            playing
                                                            className={`${styles.reactPlay} react-player`}
                                                            width='90%'
                  ...
                  > */}
                                ...
                                >
                                    <ReactPlayer
                                        url={[
                                            {
                                                src: `${base_url}${
                                                    props.dataAPIKi.included[leng4 / 2]?.attributes?.uri?.url
                                                }`,
                                                type: 'video/mp4',
                                            },
                                        ]}
                                        light={`${base_url}/${props.dataAPIKi?.included[0]?.attributes?.uri?.url}`}
                                        controls
                                        playing
                                        className={`${styles.reactPlayer} react-player`}
                                        width='95%'
                                ...
                                <h3 className={`${styles.titleVideo}`} style={{fontSize: 18}}>
                                    {props.dataAPIKi.data[0].attributes.title}
                                </h3>
                                <hr className='line'/>
                                <div className={styles.SliderVideoList1}>
                                    <Slider {...settings} className='slide my-4'>
                                        {props.dataAPIKi?.data.map((item, i) => {
                                            return (
                                                // <div
                                                //   key={i.toString()}
                                                //   className='SliderVideoList-data1 d-flex flex-wrap'
                                                    ...
                                                    >
                                                        <ReactPlayer
                                                            url={[
                                                                {
                                                                    src: `${base_url}${
                                                                        props.dataAPIKi?.included[i + leng4 / 2]
                                                                            ?.attributes?.uri?.url
                                                                    }`,
                                                                    type: 'video/mp4',
                                                                },
                                                            ]}
                                                            light={`${base_url}${props.dataAPIKi?.included[i]?.attributes?.uri?.url}`}
                                                            controls
                                                            playing
                                                            className={`${styles.reactPlay} react-player`}
                                                            width='90%'
                  ...
                  > */}
                                ...
                                >
                                    <ReactPlayer
                                        url={[
                                            {
                                                src: `${base_url}${
                                                    props.dataAPIDh.included[leng1 / 2]?.attributes?.uri?.url
                                                }`,
                                                type: 'video/mp4',
                                            },
                                        ]}
                                        light={`${base_url}/${props.dataAPIDh?.included[0]?.attributes?.uri?.url}`}
                                        controls
                                        playing
                                        className={`${styles.reactPlayer} react-player`}
                                        width='95%'
                                ...
                                <h3 className={`${styles.titleVideo}`} style={{fontSize: 18}}>
                                    {props.dataAPIDh.data[0].attributes.title}
                                </h3>
                                <hr className='line'/>
                                <div className={styles.SliderVideoList1}>
                                    <Slider {...settings} className='slide my-4'>
                                        {props.dataAPIDh?.data.map((item, i) => {
                                            return (
                                                // <div
                                                //   key={i.toString()}
                                                //   className='SliderVideoList-data1 d-flex flex-wrap'
                                                    ...
                                                    >
                                                        <ReactPlayer
                                                            url={[
                                                                {
                                                                    src: `${base_url}${
                                                                        props.dataAPIDh?.included[i + leng1 / 2]
                                                                            ?.attributes?.uri?.url
                                                                    }`,
                                                                    type: 'video/mp4',
                                                                },
                                                            ]}
                                                            light={`${base_url}${props.dataAPIDh?.included[i]?.attributes?.uri?.url}`}
                                                            controls
                                                            playing
                                                            className={`${styles.reactPlay} react-player`}
                                                            width='90%'
