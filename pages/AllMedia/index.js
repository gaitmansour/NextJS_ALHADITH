                ...
                <div className="flex-fill " style={{width: "100%"}}>
                    <div className="row first-roww">
                        <div className="col-lg-7 col-md-7 col-sm-1 category1">
                            <div>
                                <h3 className="titlePage" style={{width: "40%", fontSize: 18, float: "right"}}>برامج على
                                    الشبكات
                                    الاجتماعية</h3>
                                <hr style={{
                                    width: "60%",
                            ...
                            <div className="box-first-video">
                                <div className="btn-play">
                                    <button type="button" className="btn  p-0 position-relative" id="bttn"
                                            onClick={() => handleStart()}>
                                        <div className="player-wrapper">
                                            <ReactPlayer
                                                url={[{
                                                    src: `${base_url}${dataAPI.included[leng / 2]?.attributes?.uri?.url}`,
                                                    type: 'video/mp4'
                                                }]}
                                ...
                                <h3 className="titlePage" style={{fontSize: 18}}>{dataAPI.data[0].attributes.title}</h3>
                                <hr className="line"/>
                                        ...
                                        {dataAPI?.data.map((item, i) => {
                                            return (
                                                <div key={i.toString()}
                                                    ...
                                                    <div key={i.toString()}
                                                         className="item-card-content position-relative d-flex flex-column mt-4 mb-2">
                                                        <div className="player-wrapper">
                                                            <ReactPlayer
                                                                url={[{
                                                                    src: `${base_url}${dataAPI?.included[i + (leng / 2)]?.attributes?.uri?.url}`,
                                                                    type: 'video/mp4'
                                                                }]}
                        ...
                        <div className="col-lg-5 col-md-5 col-sm-1">
                            <div style={{height: "80px", marginBottom: '25px'}}>
                                <svg style={{float: "right", width: '30%', marginTop: '8px'}}
                                     xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#FF794D"
                                    ...
                                    return (
                                        <div key={i} className="row no-gutters my-5 mx-4">
                                            <div className="col-auto">
                                                <Image loader={myLoader} src={item.field_thumbnail_live}
                                                       className="img-fluid"
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-1 category1">
                            <div>
                                <h3 className="titlePage" style={{width: "40%", fontSize: 18, float: "right"}}>برامج
                                    تلفزية</h3>
                                <hr style={{
                                    width: "60%",
                                    float: "right",
                            ...
                            <div className="box-first-video">
                                <div className="btn-play">
                                    <button type="button" className="btn  p-0 position-relative" id="bttn"
                                        ...
                                        <div className="player-wrapper">
                                            <ReactPlayer
                                                url={[{
                                                    src: `${base_url}${dataAPIBt.included[leng2 / 2]?.attributes?.uri?.url}`,
                                                    type: 'video/mp4'
                                                }]}
                                ...
                                <h3 className="titlePage"
                                    style={{fontSize: 18}}>{dataAPIBt.data[0].attributes.title}</h3>
                                <hr className="line"/>
                                                ...
                                                <div key={i.toString()}
                                                    ...
                                                    {item?.attributes?.field_lien_video.uri && <i className={`fas fa-play`}></i>} */}
                                                        <div className="player-wrapper">
                                                            <ReactPlayer
                                                                url={[{
                                                                    src: `${base_url}${dataAPIBt?.included[i + (leng2 / 2)]?.attributes?.uri?.url}`,
                                                                    type: 'video/mp4'
                                                                }]}
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-1 category1">
                            ...
                            <div className="box-first-video">
                                <div className="btn-play">
                                    <button type="button" className="btn  p-0 position-relative" id="bttn"
                                        ...
                                        <div className="player-wrapper">
                                            <ReactPlayer
                                                url={[{
                                                    src: `${base_url}${dataAPIBi.included[leng3 / 2]?.attributes?.uri?.url}`,
                                                    type: 'video/mp4'
                                                }]}
                                ...
                                <h3 className="titlePage"
                                    style={{fontSize: 18}}>{dataAPIBi.data[0].attributes.title}</h3>
                                <hr className="line"/>
                                <div className="SliderVideoList1">
                                    <Slider {...settings} className="slide my-4">
                                                ...
                                                <div key={i.toString()}
                                                    ...
                                                    <div key={i.toString()}
                                                        ...
                                                        <div className="player-wrapper">
                                                            <ReactPlayer
                                                                url={[{
                                                                    src: `${base_url}${dataAPIBi?.included[i + (leng3 / 2)]?.attributes?.uri?.url}`,
                                                                    type: 'video/mp4'
                                                                }]}
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-1 category1">
                            <div>
                                <h3 className="titlePage" style={{width: "40%", fontSize: 18, float: "right"}}>الدروس
                                    الحسنية</h3>
                                <hr style={{
                                    width: "60%",
                                    float: "right",
                            ...
                            <div className="box-first-video">
                                <div className="btn-play">
                                    <button type="button" className="btn  p-0 position-relative" id="bttn"
                                        ...
                                        <div className="player-wrapper">
                                            <ReactPlayer
                                                url={[{
                                                    src: `${base_url}${dataAPIKi.included[leng4 / 2]?.attributes?.uri?.url}`,
                                                    type: 'video/mp4'
                                                }]}
                                ...
                                <h3 className="titlePage"
                                    style={{fontSize: 18}}>{dataAPIKi.data[0].attributes.title}</h3>
                                <hr className="line"/>
                                <div className="SliderVideoList1">
                                    <Slider {...settings} className="slide my-4">
                                                ...
                                                <div key={i.toString()}
                                                    ...
                                                    {item?.attributes?.field_lien_video.uri && <i className={`fas fa-play`}></i>} */}
                                                        <div className="player-wrapper">
                                                            <ReactPlayer
                                                                url={[{
                                                                    src: `${base_url}${dataAPIKi?.included[i + (leng4 / 2)]?.attributes?.uri?.url}`,
                                                                    type: 'video/mp4'
                                                                }]}
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-1 category1">
                            <div>
                                <h3 className="titlePage" style={{width: "30%", fontSize: 18, float: "right"}}>الدروس
                                    الحديثية</h3>
                                <hr style={{
                                    width: "62%",
                                    float: "right",
                            ...
                            <div className="box-first-video">
                                <div className="btn-play">
                                    <button type="button" className="btn  p-0 position-relative" id="bttn"
                                        ...
                                        <div className="player-wrapper">
                                            <ReactPlayer
                                                url={[{
                                                    src: `${base_url}${dataAPIDh.included[leng1 / 2]?.attributes?.uri?.url}`,
                                                    type: 'video/mp4'
                                                }]}
                                ...
                                <h3 className="titlePage"
                                    style={{fontSize: 18}}>{dataAPIDh.data[0].attributes.title}</h3>
                                <hr className="line"/>
                                <div className="SliderVideoList1">
                                    <Slider {...settings} className="slide my-4">
                                                ...
                                                <div key={i.toString()}
                                                    ...
                                                    {item?.attributes?.field_lien_video.uri && <i className={`fas fa-play`}></i>} */}
                                                        <div className="player-wrapper">
                                                            <ReactPlayer
                                                                url={[{
                                                                    src: `${base_url}${dataAPIDh?.included[i + (leng1 / 2)]?.attributes?.uri?.url}`,
                                                                    type: 'video/mp4'
                                                                }]}
                                                        ...
                                                        <p className="m-0 py-3 description px-4" style={{
                                                            fontSize: 12,
                                                            textAlign: 'right'
                                                        }}>{item?.attributes?.title}</p>
                                                    </div>
